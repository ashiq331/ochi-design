              ...
              <div className="w-fit flex items-center gap-3">
                {index === 1 && (
                  <motion.div
                    ...
                    className="w-[10vw] h-[5.2vw] rounded-md relative top-[0.5vw] overflow-hidden"
                  >
                    <img
                      src="https://images.pexels.com/photos/2471415/pexels-photo-2471415.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                      alt=""
                      width="100%"
                      height="100%"
                    />
